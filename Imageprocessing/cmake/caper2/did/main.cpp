...
int main()
{
	...
	Mat srcimage2 = imread("22.tif");
        ...
        for (int i = 0;i < r2;i++){
        	for(int j = 0;j < c2;j++){
               	srcimage2.at<Vec3b>(i,j)[0]=float(srcimage2.at<Vec3b>(i,j)[0]/128);
                srcimage2.at<Vec3b>(i,j)[1]=float(srcimage2.at<Vec3b>(i,j)[1]/128);
                srcimage2.at<Vec3b>(i,j)[2]=float(srcimage2.at<Vec3b>(i,j)[2]/128);	   
             	}       
       	}
        for(int i = 0;i < r1;i++){
            	for(int j = 0;j < c1;j++){
		...
		if(dstimage.at<Vec3b>(i,j)[0]>=255) dstimage.at<Vec3b>(i,j)[0] =255;
		if(dstimage.at<Vec3b>(i,j)[1]>=255) dstimage.at<Vec3b>(i,j)[1] =255;
		if(dstimage.at<Vec3b>(i,j)[2]>=255) dstimage.at<Vec3b>(i,j)[2] =255;
            	}
      	} 
