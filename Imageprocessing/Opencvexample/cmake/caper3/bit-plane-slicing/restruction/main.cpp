	...
	for(int i = 0; i < r; i ++)
		{
			...
			{	
				...
				data_end1[j]=(data1[j]/255)*128+(data2[j]/255)*64;
				data_end2[j]=(data1[j]/255)*128+(data2[j]/255)*64+(data3[j]/255)*32;
				data_end3[j]=(data1[j]/255)*128+(data2[j]/255)*64+(data3[j]/255)*32+(data4[j]/255)*16;
			}
		}
